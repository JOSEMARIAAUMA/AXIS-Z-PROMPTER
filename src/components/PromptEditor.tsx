...
import { generateTranslationAndTags } from '../services/geminiService';

interface PromptEditorProps {
  prompt: PromptItem | null;
  categories: CategoryMap; 
  availableApps: string[]; // New prop
    ...
    <div className="h-full flex flex-col bg-arch-900">
      ...
      <div className="flex items-center justify-between p-4 border-b border-arch-800 bg-arch-950">
        <div className="flex items-center space-x-3">
            {/* Left side actions (empty for now, button moved to header) */}
        </div>
