...
import { PromptItem, Category, AppSettings, FilterState, CompiledPrompt, CategoryMap, SavedComposition, LibrarySuggestion, AreaType } from './types';
        ...
        >
            ...
            <div className="flex border-b border-arch-800 bg-arch-950 shrink-0">
                <button 
                    ...
                    className={`flex-1 py-3 text-xs font-semibold uppercase tracking-wide transition-colors flex items-center justify-center space-x-2 ${
                        rightTab === 'COMPILER' 
